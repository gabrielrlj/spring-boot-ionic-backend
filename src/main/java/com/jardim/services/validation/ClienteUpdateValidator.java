...
public class ClienteUpdateValidator implements ConstraintValidator<ClienteUpdate, ClienteDTO> {
	...
	@Override   
	 public boolean isValid(ClienteDTO objDto, ConstraintValidatorContext context) { 
		...
		//pega o número que for passado na uri para fazer a verificação
		...
		//o email que está sendo passado não pode aparecer no banco, apenas se for o email do cliente que estamos atualizando
