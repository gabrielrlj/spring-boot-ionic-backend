...
import com.jardim.dto.ProdutoDTO;
import com.jardim.resources.utils.URL;
import com.jardim.services.ProdutoService;
...
public class ProdutoResource {
	...
	@GetMapping(value="/{id}")
	public ResponseEntity<Produto> listarPorId(@PathVariable Integer id) {
